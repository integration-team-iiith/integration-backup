...
- Total Number of Labs, need not to be converted : 8
- Total Number of labs to be converted  to javascript :   11
- Total Number of Experiments to be converted to javascript : 93

** How the common Libraries across the labs are Identified ? : 

 Common libraries are identified, across the labs, based on two scenarios: 
